...
export default class FormReceitas extends Component {
...
export const RowReceitas = props => {
		...
		<tr>
			...
			<Item>
				<UncontrolledDropdown>
					...
					<DropdownMenu right>
						<DropdownItem href={`${mounturl}/api/receitas/${props.data.id}/recibo`} target='_blank'>
