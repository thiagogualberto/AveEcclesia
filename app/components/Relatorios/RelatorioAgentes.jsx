...
const options = [
	{ label: 'Todos Agentes', value: 'lista' },
	// { label: 'Funções', value: 'funcoes' },
	{ label: 'Aniversariantes', value: 'nivers' },
]

class RelatorioAgentes extends Component {
	...
	openRelatorio(e) {
		...
		window.open(window.mounturl + '/api/relatorio/agentes?' + query)
	}
	...
	render () {
		return (
			<Container title='Relatório de Agentes'>
...
export default RelatorioAgentes